...
import com.example.mypolka.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void uploadProfileImageStorage() {
        ...
        progressDialog.setMessage("Загрузка фотографии для профиля...");
        progressDialog.show();
        ...
        ref.putFile(imageUri)
                .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onProgress(@NonNull UploadTask.TaskSnapshot snapshot) {
                        ...
                        progressDialog.setMessage("Загрузка фотографии профиля. Прогресс: "+(int)progress+"%");
                    }
                })
            ...
            .addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Utils.toast(ProfileEditActivity.this, "Ошибка обновления..."+e.getMessage());
                }
            });
     }

    private void updateProfileDb(String imageUrl){
        progressDialog.setMessage("Обновление информации пользователя...");
        progressDialog.show();
            ...
            reference.child(firebaseAuth.getUid())
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Log.d(TAG, "onFailure: ", e);
                            progressDialog.dismiss();
                            Utils.toast(ProfileEditActivity.this, "Failed to updated..."+e.getMessage());
                        }
                    });
        }
            ...
            new ActivityResultCallback<Map<String, Boolean>>() {
                ...
                public void onActivityResult(Map<String, Boolean> result) {
                    ...
                    if (areAllGranted){
                        ...
                        Utils.toast(ProfileEditActivity.this, "Отсутствие доступа...");
                    }
                }
            }
    );
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Utils.toast(ProfileEditActivity.this, "Отмена...");
                    }
                }
            }
    );
