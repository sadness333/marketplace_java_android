...
import com.example.mypolka.databinding.ActivityLoginOptionsBinding;
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Utils.toast(LoginOptionsActivity.this, "Отмена операции...");
                    }
                }
            }
    );
        ...
        ref.child(registerUserUid)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Utils.toast(LoginOptionsActivity.this, "Ошибка сохранения информации о пользователе: "+e.getMessage());
                    }
                });
    }
}